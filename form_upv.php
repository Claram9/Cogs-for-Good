...
?>
<form class="form" id="upv-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  <h3 class="header">Take part as a team</h3>  
     ...
     <label class="label-form" for="email">E-mail <br>
        <input class="input-text" type="text" placeholder="xxx@upv.es" name="email" value="<?php echo $email;?>">
     </label><br>
